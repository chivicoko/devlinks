...
import { FacebookOutlined, GitHub, Instagram, LinkedIn, MediationOutlined, X, YouTube } from '@mui/icons-material';
...
const platformOptions = [
  { value: 'GitHub', label: 'GitHub', icon: <GitHub />, color: '#ffffff' },
  { value: 'YouTube', label: 'YouTube', icon: <YouTube />, color: '#ffffff' },
  { value: 'Facebook', label: 'Facebook', icon: <FacebookOutlined />, color: '#ffffff' },
  { value: 'Twitter', label: 'Twitter', icon: <X />, color: '#ffffff' },
  { value: 'LinkedIn', label: 'LinkedIn', icon: <LinkedIn />, color: '#ffffff' },
  { value: 'Instagram', label: 'Instagram', icon: <Instagram />, color: '#ffffff' },
  { value: 'Other', label: 'Other', icon: <MediationOutlined />, color: '#ffffff' },
];
...
const Links: React.FC = () => {
  ...
  const addLinkSection = () => {
    setLinks([...links, { platform: platformOptions[0].value, url: '' }]);
        ...
        <div className="flex flex-wrap w-full gap-4 text-gray-800">
          ...
          <div className="flex-1 lg:flex-[2] bg-white rounded-lg">
            <div className="p-10 max-h-screen overflow-y-auto hide-scrollbar">
              ...
              {showLinksSection && links.length > 0 && (
